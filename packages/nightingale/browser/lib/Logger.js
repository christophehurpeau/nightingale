    ...
    */
    ...
    _createClass(Logger, [{
        ...
        value: /**
            ...
            var _getForLogger = (0, _config.getForLogger)(this.key);

            var handlers = _getForLogger.handlers;
            var processors = _getForLogger.processors;
        ...
        value: /**
                ...
                * @param metadata
                * @param metadataStyles
               */function error(message, metadata, metadataStyles) {
