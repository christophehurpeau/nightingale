...
if (nodeVersionMajor > 8 || (nodeVersionMajor === 8 && nodeVersionMinor >= 3))
  module.exports = require('./dist/children-node8' + (production ? '' : '-dev') + '.cjs');
/* istanbul ignore next */
else if (nodeVersionMajor > 6 || (nodeVersionMajor === 6 && nodeVersionMinor >= 5))
  module.exports = require('./dist/children-node6' + (production ? '' : '-dev') + '.cjs');
/* istanbul ignore next */
else module.exports = require('./dist/children-node4' + (production ? '' : '-dev') + '.cjs');
